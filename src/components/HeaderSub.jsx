...
function HeaderSub(props) {
  ...
  const style =`content-heading ${title}-text`
	...
	return (
      ...
      <h1 className="myname myname-headerSub"><Link to="/adventure">a</Link>llan <Link className="e" to="/excitement">E</Link>  <Link to="/beauty">b</Link>ot<Link to="/travel">t</Link></h1>      <h2 className={style} >{title}</h2>
